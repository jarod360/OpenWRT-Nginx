...
#修改默认密码为root
sed -i 's/root:.*/root:$1$tTPCBw1t$ldzfp37h5lSpO9VXk4uUE\/:18336:0:99999:7:::/g' files/etc/shadow


sed -i 's/openwrt.proxy.ustclug.org/downloads.openwrt.org/g' files/etc/opkg/distfeeds.conf
sed -i '/18.06.8/d' files/etc/opkg/distfeeds.conf
sed -i 's/releases/snapshots/g' files/etc/opkg/distfeeds.conf
