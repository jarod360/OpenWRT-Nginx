...
sed -n "161a\	echo \'*/60 * * * * sh/etc/memclean.sh\' ＞ \$\(1\)/etc/crontabs/root" package/base-files/Makefile
sed -n '182a\	chmod 7777 $(1)/etc/memclean.sh' package/base-files/Makefile
