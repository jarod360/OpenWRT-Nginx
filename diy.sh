...
sed -i '161s#crontabs#echo '*/60 * * * * sh/etc/memclean.sh' ＞ $(1)/etcrontabs/root#a' package/base-files/Makefile
sed -i '182s#tmp#chmod 7777 $(1)/etc/memclean.sh#a' package/base-files/Makefile
